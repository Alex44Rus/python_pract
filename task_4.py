...
if cost > revenue:
    ...
    margin = revenue - cost
    print(f"Финансовый результат - прибыль. Ее величина: {margin}")
    print(f"Рентабельнось выручки = {margin / revenue}")
    empl_count = int(input("Введите численность сотрудников:  "))
    print(f"Прибыть в расчете на одного сотрудника = {margin / empl_count}")
